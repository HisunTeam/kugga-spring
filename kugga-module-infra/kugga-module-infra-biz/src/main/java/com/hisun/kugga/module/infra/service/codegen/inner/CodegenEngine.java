...
import com.hisun.kugga.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "kugga-module-${table.moduleName}/" + // 顶级模块
                "kugga-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "kugga-module-${table.moduleName}/" + // 顶级模块
                "kugga-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "kugga-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }

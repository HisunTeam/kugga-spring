...
public class SocketioRedissonConfiguration {
    ...
    public StoreFactory clientStoreFactory(Config redissonConfig) {
        Redisson redisson = (Redisson) Redisson.create(redissonConfig);
//        Redisson redissonPub = (Redisson) Redisson.create(redissonConfig);
//        Redisson redissonSub = (Redisson) Redisson.create(redissonConfig);
        return new RedissonStoreFactory(redisson, redisson, redisson);
    }

...
import com.hisun.kugga.framework.socketio.store.RedisTemplateStoreFactory;
...
public class SocketioRedisTemplateConfiguration {
    ...
    @Bean
    public StoreFactory clientStoreFactory(RedisConnectionFactory connectionFactory) {

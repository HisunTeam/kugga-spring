package com.hisun.kugga.framework.tracer.config;

import com.hisun.kugga.framework.common.enums.WebFilterOrderEnum;
import com.hisun.kugga.framework.tracer.core.aop.BizTraceAspect;
import com.hisun.kugga.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "kugga.tracer", value = "enable", matchIfMissing = true)
public class KuggaTracerAutoConfiguration {

package com.hisun.kugga.framework.common.pojo;
...
public class CommonResult<T> implements Serializable {
    ...
    public static <T> CommonResult<T> error(ServiceException serviceException, T data) {
        return error(serviceException.getCode(), serviceException.getMessage(), data);
    }
}

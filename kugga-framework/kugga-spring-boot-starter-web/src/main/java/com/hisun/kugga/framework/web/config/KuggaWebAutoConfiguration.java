package com.hisun.kugga.framework.web.config;
...
import com.hisun.kugga.framework.web.core.filter.CacheRequestBodyFilter;
import com.hisun.kugga.framework.web.core.filter.DemoFilter;
import com.hisun.kugga.framework.web.core.filter.LoggerFilter;
import com.hisun.kugga.framework.web.core.filter.XssFilter;
import com.hisun.kugga.framework.web.core.handler.GlobalExceptionHandler;
import com.hisun.kugga.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class KuggaWebAutoConfiguration implements WebMvcConfigurer {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "kugga.demo", havingValue = "true")

package com.hisun.kugga.framework.web.core.handler;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.hisun.kugga.framework.apilog.core.service.ApiErrorLog;
...
import static com.hisun.kugga.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    /**
     * 处理业务异常 ServiceException，不打印堆栈信息
     * <p>
     * 例如说，商品库存不足，用户手机号已存在。
     */
    @ExceptionHandler(value = ServiceException.class)
    public CommonResult<?> serviceExceptionHandler(ServiceException ex) {
        log.info("[serviceExceptionHandler]:{}==>{}", ex.getCode(), ex.getMessage());
        return CommonResult.error(ex.getCode(), ex.getMessage());
    }

    @ExceptionHandler(AsyncRequestTimeoutException.class)
    public CommonResult<?> asyncRequestTimeoutExceptionHandler(AsyncRequestTimeoutException ex) {
        return CommonResult.error(REQUEST_TIMEOUT.getCode(), REQUEST_TIMEOUT.getMsg());
    }
    ...
    private void initExceptionLog(ApiErrorLog errorLog, HttpServletRequest request, Throwable e) {
        ...
        errorLog.setRequestParams(JsonUtils.toJsonString(ServletUtil.getParamMap(request)));
        errorLog.setRequestBody(ServletUtil.getBody(request));
